...
SERVERS = [
    {"ip": "0.0.0.0", "port": 0000} # Add more servers here
]
...
async def on_raw_reaction_add(payload):
    ...
    # Identify which server the reaction was for
...
async def on_ready():
    ...
    # Clear old messages in the channel before sending new ones
    await clear_channel_messages(client.status_channel)
    
    # Send an embed for each server and track the messages
